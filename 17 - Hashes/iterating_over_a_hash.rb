# Iteration is the process of looping over the places/components
# of an object
...
# values     - Return array of hash's keys
...
salaries.each_value { |salary| puts "The next empoloyee earns #{salary}" }
puts
